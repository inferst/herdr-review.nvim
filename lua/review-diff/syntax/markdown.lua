...
---Collect injection blocks from markdown lines.
---Returns a list of injection descriptors with lang, lines, and line_offset.
---@param lines string[]
---@param syntax_module table
---@return table[]
function M.get_injections(lines, syntax_module)
  local injections = {}
  local fence = nil
  ...
  for line_idx, line in ipairs(lines) do
    if fence then
      if is_fence_end(line, fence.marker) then
        ...
        local lang = ft and syntax_module.language_for_filetype(ft) or nil
